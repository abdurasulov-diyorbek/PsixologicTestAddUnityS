...
public class WsCustomAdapter extends BaseAdapter {
	...
	WsCustomAdapter(Context context, List<WsRowItem> rowItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//if (convertView == null) {
			convertView = mInflater.inflate(R.layout.ws_app_list_item, null);
			...
			WsRowItem row_pos = rowItems.get(position);
